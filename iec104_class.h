...
class iec104_class
{
    ...
    static const unsigned int M_IT_NA_1 = 15; // 电能累积量integrated totals
	static const unsigned int M_ME_ND_1 = 21; // 不带品质的归一化遥测包
	...
	void solicitIntegratedTotal();//召唤电能量
